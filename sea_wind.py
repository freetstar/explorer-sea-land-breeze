...
for year in range(2005,2019):
    ...
    with open("sea_wind_results/sea_wind_%s_result.txt" % year,"w") as f:
        for name, group in grouped:
            #筛选出12小时到20小时的
            group_1321 = group[ (group.Datetime.dt.hour > 12) & (group.Datetime.dt.hour < 21)]
            #满足海陆凤的index
            s_index = group_1321[(45 <= group_1321["Wind_dir"] ) & (group_1321["Wind_dir"] <= 180 ) & (group_1321["Wind_speed"] >= 1.0 )].index
            if len(s_index) >= 3:
